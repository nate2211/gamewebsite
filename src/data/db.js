...
export function serializeWorld(world) {
  return {
    ...
    arcana: world.arcana,
    enchantments: world.enchantments || {},
    openedTreasureChests: world.openedTreasureChests || [],
    villageQuests: world.villageQuests || { accepted: [], claimed: [] },
    factions: world.factions || { reputation: { sunspire: 0, ironroot: 0, tideborn: 0 }, accepted: [], claimed: [], discovered: [] },
    ...
    mobs: world.mobs,
    mount: world.mount,
    seated: world.seated || null,
    furnaces: world.furnaces,
    storageChests: world.storageChests || {},
    colony: world.colony,
    housing: world.housing || { beds: {}, storage: {} },
    bosses: world.bosses || { activeBossId: null, activeBossType: null, defeated: [] },
